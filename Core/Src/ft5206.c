...
_m_tp_dev tp_dev = {FT5206_Init, FT5206_Scan, {0}, {0}, 0};
...
uint8_t FT5206_Init(void) {
  ...
  if ((temp[0] == 0X30 && temp[1] == 0X03) || temp[1] == 0X01 ||
      temp[1] == 0X02) //版本:0X3003/0X0001/0X0002
  {
...
const uint16_t GT911_TPX_TBL[5] = {GT_TP1_REG, GT_TP2_REG, GT_TP3_REG,
